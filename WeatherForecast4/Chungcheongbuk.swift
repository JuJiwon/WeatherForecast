...
class Chungcheongbuk: UIViewController, XMLParserDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let requestA = NSMutableURLRequest(url: URL(string: "http://www.kma.go.kr/weather/forecast/mid-term-rss3.jsp?stnId=131")!)
